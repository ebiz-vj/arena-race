...
describe("scoring", () => {
    it("position: 0.13 * (6 - row) per token", () => {
        ...
        const pts = (0, scoring_1.computePositionPointsThisTurn)(positions);
    ...
    it("survival cap 75 applied at ranking", () => {
        ...
        (0, scoring_1.applySurvivalCapAndTotal)(scores);
    ...
    it("placement tie-break: total then overtake+zone then overtake count", () => {
        ...
        const overtakeCounts = [0, 1, 0, 0];
        const placement = (0, scoring_1.computePlacement)(scores, overtakeCounts);
